...
begin
    ...
    # grid size3
    h = 0.075 * 0.75# 0.075 * 0.5 # 0.075 <-> från artikel
    # # # # # # # # # #
    # Finite element  #
    # # # # # # # # # #
...
# Create grids  #
# # # # # # # # #
results_dir = joinpath(@__DIR__, "../../results/medsafe")
grid1 = createQuarterLabyrinthMeshVeryRounded2M(joinpath(results_dir,"mesh_1"), x₀, y₀, th, B, b, Δl, H, r, h/2);
