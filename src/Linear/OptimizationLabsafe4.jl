...
# Create grids  #
# # # # # # # # #
results_dir = joinpath(@__DIR__, "../../results/safe4")
grid1 = createQuarterLabyrinthMeshRounded(joinpath(joinpath(results_dir,"mesh_1"), x₀, y₀, th, B, b, Δl, H, r, h/2));
...
function Optimize(dh)
    ...
    while kktnorm > tol || OptIter < 2 && true_iteration < 500
        ...
        # # # # # # # # # # # # # #src/Linear/OptimizationLabsafe.jl
